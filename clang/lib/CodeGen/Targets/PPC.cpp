...
public:
  PPC32_SVR4_ABIInfo(CodeGen::CodeGenTypes &CGT, bool SoftFloatABI,
                     ...
                     unsigned RLen, bool ComplexInRegABI)
...
ABIArgInfo PPC32_SVR4_ABIInfo::handleComplex(QualType Ty, uint64_t &TypeSize) const{
...
ABIArgInfo PPC32_SVR4_ABIInfo::classifyArgumentType(QualType Ty, int &ArgGPRsLeft) const{
  ...
  if (isComplexInRegABI && Ty->isAnyComplexType() && TypeSize <= RLen*ArgGPRsLeft) {
...
Address PPC32_SVR4_ABIInfo::EmitVAArg(CodeGenFunction &CGF, Address VAList,
  ...
  if (getTarget().getTriple().isOSDarwin()) {
    ...
    bool IsIndirect = classifyArgumentType(Ty, ArgGPRs).isIndirect();

    CharUnits SlotSize = CharUnits::fromQuantity(4);
    return emitVoidPtrVAArg(CGF, VAList, Ty,
                            IsIndirect, TI, SlotSize,
...
std::unique_ptr<TargetCodeGenInfo>
CodeGen::createPPC32TargetCodeGenInfo(CodeGenModule &CGM, bool SoftFloatABI, unsigned RLen) {
